...
const Antd2 = (props) => {
  ...
  const onFill = () => {
    const obj={...activate}
    form.setFieldsValue({
      Attribute: formContent.geoName,
      Parent: formContent.geoCode,
      Code: formContent.attributeKey,
      Name: formContent.geoParentCode
    });
  ...
  return (
    ...
    >
      ...
      >
        <Input name="Parent" readOnly={true} onChange={handle} 
        // placeholder={objects.Parent} 
        />
      </Form.Item>
      <Form.Item
        label="Code"
      ...
      >
        <Input name="Code" readOnly={true} onChange={handle}
         //placeholder={objects.Code}
          />
      </Form.Item>
      ...
      >
        <Input name="Name" readOnly={true} onChange={handle}
